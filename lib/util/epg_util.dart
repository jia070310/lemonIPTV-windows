...
class EpgUtil {
  ...
  static Future<void> initEpg() async {
    try {
      final prefs = await SharedPreferences.getInstance();
      final currentEpgUrl = prefs.getString('currentEpgUrl');
      if (currentEpgUrl != null && currentEpgUrl.isNotEmpty) {
        LogUtil.v('初始化节目表:::$currentEpgUrl');
        await loadEPGXML(currentEpgUrl);
      }
    } catch (e) {
      LogUtil.e('初始化节目表失败:::$e');
    }
  }
}
