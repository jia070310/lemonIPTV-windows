                ...
                return Builder(
                  builder: (context) {
                    return Material(
                      ...
                      child: InkWell(
                        overlayColor: isTV ? WidgetStateProperty.all(const Color(0xFFFFF44F).withValues(alpha: 0.2)) : null,
                        onTap: () {
                        ...
                        child: Ink(
                          ...
                          decoration: BoxDecoration(
                            gradient: widget.channelListModel!.playGroupIndex == index
                                ? LinearGradient(colors: [const Color(0xFFFFF44F).withValues(alpha: 0.6), const Color(0xFFFFF44F).withValues(alpha: 0.3)])
                                : null,
                          ),
                          child: Align(
                            ...
                            child: Text(
                              title!,
                              style: TextStyle(
                                color: widget.channelListModel!.playGroupIndex == index ? const Color(0xFFFFF44F) : Colors.white,
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    '$serialNum $name',
                                    style: TextStyle(
                                      color: widget.channelListModel!.playChannelIndex == index ? const Color(0xFFFFF44F) : Colors.white,
                                      fontWeight: FontWeight.bold,
                                    ),
                                  ),
                                ),
                                if (widget.channelListModel!.playChannelIndex == index)
                                  SpinKitWave(size: 20, color: const Color(0xFFFFF44F).withValues(alpha: 0.8)),
                              ],
                            ),
                          ),
                        ),
                              ...
                              children: [
                                Text(
                                  ...
                                  style: TextStyle(
                                    ...
                                    color: isSelect ? const Color(0xFFFFF44F) : Colors.white,
