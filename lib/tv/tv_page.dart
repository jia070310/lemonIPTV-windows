  ...
  _focusControlEvent(BuildContext context, KeyEvent e) async {
    ...
    switch (e.logicalKey) {
      ...
      case LogicalKeyboardKey.select:
        ...
        LogUtil.v('按了确认键:::isPlaying:${widget.isPlaying}:::video:controller:${widget.controller}');
        if (widget.controller != null &&
            widget.isPlaying == false &&
            widget.isBuffering == false) {
          widget.controller?.player.play();
          return;
        }
                      ...
                      children: [
                        widget.controller != null
                            ? AspectRatio(
                                ...
                                child: SizedBox(width: double.infinity, child: Video(controller: widget.controller!, controls: NoVideoControls)),
                              )
                            : VideoHoldBg(toastString: _drawerIsOpen ? '' : widget.toastString),
                        if (_drawerIsOpen) DatePositionWidget(player: widget.controller?.player),
