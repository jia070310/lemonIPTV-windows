    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            if (isFocused) ...[
              const Color(0xFFFFF44F).withValues(alpha: 0.3),
              const Color(0xFFFFF44F).withValues(alpha: 0.1),
            ] else if (isSelected) ...[
              const Color(0xFFFFF44F).withValues(alpha: 0.6),
              const Color(0xFFFFF44F).withValues(alpha: 0.3),
            ] else ...[
              Colors.transparent,
              Colors.transparent,
      ...
      child: Center(
        child: Text(
          title,
          style: TextStyle(color: isFocused ? Colors.white : (isSelected ? const Color(0xFFFFF44F) : Colors.white), fontWeight: FontWeight.bold),
        ),
      ),
    );
  }
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          if (isSelected) SpinKitWave(size: 20, color: const Color(0xFFFFF44F).withValues(alpha: 0.8)),
        ],
      ),
    );
  }
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              ...
              color: isCurrentPlaying ? const Color(0xFFFFF44F) : Colors.white,
