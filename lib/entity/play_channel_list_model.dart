...
class Channel {
  Channel({this.id, this.logo, this.title, this.urls, this.serialNum, this.groupIndex, this.channelIndex, this.userAgent, this.headers});
  ...
  Channel copyWith({String? id, String? logo, String? title, List<String>? urls, int? serialNum, int? groupIndex, int? channelIndex, String? userAgent, Map<String, String>? headers}) => Channel(
    id: id ?? this.id,
    logo: logo ?? this.logo,
