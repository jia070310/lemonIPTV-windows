                      ...
                      children: [
                        ...
                        if (EnvUtil.isTV())
                          _buildSwitchItem(
                            ...
                            title: '上下键切换频道',
                            subtitle: '开启后原先的设置页面和线路选择页面改成左右键打开',
                        ...
                        _buildActionItem(
                          ...
                          trailing: Builder(
                            builder: (ctx) {
                              ...
                              if (CheckVersionUtil.latestVersionEntity == null) {
                                return Text('已是最新版本', style: TextStyle(color: Colors.white.withOpacity(0.5), fontSize: 12));
                              } else if (provider.isDownloading) {
                                return Text('新版本正在下载中...${(provider.progress * 100).toStringAsFixed(1)}%', style: TextStyle(color: Colors.orange, fontSize: 12));
                              } else {
                                return Container(
                                  ...
                                  child: Text('🔴 发现新版本', style: TextStyle(color: Colors.white, fontSize: 12)),
                                );
                              }
                            },
                          ),
